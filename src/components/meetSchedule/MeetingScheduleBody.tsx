...
import { RichTextArea } from './RichTextArea'; // Adjust the path as needed
...
export const MeetingScheduleBody = () => {
  ...
  return (
    <div className="p-4 space-y-6">
      ...
      {/* Teams Plan Info */}
      <div className="border border-gray-300 p-2 flex w-10/12">
        <div className="w-10 mt-2 flex justify-center">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex-1">
            <input
              ...
              className={`w-9/12 px-2 py-2 bg-gray-100 rounded-t-lg border-b-2 outline-none text-sm ${
        ...
        {/* Date-Time Row */}
        <div className="flex items-center space-x-2 flex-wrap w-10/12">
          <div className="p-2">
        ...
        {/* Repeat Row */}
        <div className="flex items-center space-x-3 w-10/12 relative">
          <div className="p-2">
          ...
          <div className="flex-1 relative">
            <input
              ...
              className="w-4/12 px-2 py-2 bg-gray-100 rounded-t-lg border-b-2 border-gray-300 focus:border-purple-700 outline-none text-sm cursor-pointer"
            />
            {showRepeatDropdown && (
              <div className="absolute w-4/12 left-0 right-0 mt-1 border border-gray-300 bg-white rounded-lg z-10">
        ...
        {/* Description Row */}
        <div className="flex items-start space-x-3 w-10/12">
          <div className="p-2">
